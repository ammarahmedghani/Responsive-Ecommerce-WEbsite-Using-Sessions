...
<ul>    
    <li class="nav-item dropdown no-arrow mx-1">
        <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          ...
          <img style="padding-left: 6px;" src="shopping-cart.png" width="33" height="29" class="d-inline-block align-top" alt="">
          <span class="badge badge-danger"><?php if (isset($_SESSION['shopping_cart'])) {
         ...
         <div class="dropdown-menu dropdown-menu-right" aria-labelledby="alertsDropdown">
          ...
          if (isset($_SESSION['shopping_cart'])) {
            ...
            for ($i=0; $i < $count; $i++) { ?>
              ...
              <a class="dropdown-item" href="#"><?php echo $_SESSION['shopping_cart'][$i]['name'];?>
              <i> <?php echo $_SESSION['shopping_cart'][$i]['quantity'];?></i></a> 
          ...
          ?>
          <a href="cart.php?action=empty&link=index.php" class="btn-danger btn">Check Out</a>
        </div>
      </li>
</ul>
...
<div class="alert alert-success">
  <strong>Welcome!  </strong><?php echo $_SESSION['u_first'] ?>
</div>
